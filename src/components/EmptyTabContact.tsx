const EmptyTabContact = () => (
    <div className="emptyTabContact">
        ...
        <p>No contact yet</p>
        <p>There is no contact to show at this letter. try other letter to get new contacts</p>
    </div>
)

export default EmptyTabContact;